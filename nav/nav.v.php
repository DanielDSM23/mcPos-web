...
function DisplayNavBar($choice){
    ...
    echo '<div class="w-64 bg-white h-svh shadow-md sticky top-16">
            <div>
                <div class="flex items-center space-x-2 py-4 '.($array[0] ? 'bg-gray' : '').'">
                ...
                <div class="flex items-center space-x-2 py-4 '.($array[1] ? 'bg-gray' : '').'">
                ...
                if($_SESSION['role'] == 'ADMIN'){
                    echo '<div class="flex items-center space-x-2 py-4 '.($array[2] ? 'bg-gray' : '').'">
