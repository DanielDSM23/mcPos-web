...
function DisplayAuth(){
    ...
    echo '<div class="bg-green-900 text-white py-2">';
        echo '<div class="container mx-auto flex justify-center items-center">';
            echo '<div class="flex-shrink-0">';
                echo '<img class="h-12" src="img/logo.png" alt="Logo">';
            echo '</div>';
        echo '</div>';
    echo '</div>';
        ...
        echo '<div class="flex items-center justify-center h-screen">';
            echo '<div class="bg-white rounded p-16 flex flex-col w-1/3 justify-center content-center items-center">';
                ...
                echo '<form method="post" action="" class="w-full flex flex-col items-center">';
                    echo '<select class="m-5 p-2 border-2 border-gray w-full" name="id">';
                        echo '<option disabled selected>Selectionner votre identifiant</option>';
                        foreach ($users as $user){
                            echo '<option>'.$user.'</option>';
                        }
                    echo '</select>';
                    echo '<input placeholder="Entrer votre mot de passe" class="m-5 p-2 border-2 border-gray w-full" type="password" name="password"/>';
